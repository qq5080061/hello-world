...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.CseSpringCodegen", date = "2017-11-16T02:56:49.465Z")

@RestSchema(schemaId = "cseDemo")
@RequestMapping(path = "/cccccaaaa", produces = MediaType.APPLICATION_JSON)
